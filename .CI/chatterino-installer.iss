...
#define MyAppVersion "2.5.6-beta.5"
#define MyAppVersionInfo "2.5.6.5"
...
AppId={{F2C152B8-04F7-4946-AF71-CFF6CFD83BF5}
AppName={#MyAppName}
...
#else
OutputBaseFilename=Chatterino7TV.Itzon.Installer
#endif
Compression=lzma
...
[Icons]
Name: "{autoprograms}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; AppUserModelID: "dilllxd.Chatterino7Itzon"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; AppUserModelID: "dilllxd.Chatterino7Itzon"; Tasks: desktopicon
